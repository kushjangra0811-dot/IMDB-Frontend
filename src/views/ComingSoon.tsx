...
const ComingSoon = () => {
  const { data, isLoading, error, fetchNextPage, hasNextPage, isFetchingNextPage } = useUpcomingMovies();
  const movies = data?.pages.flatMap(page => page.results) || [];

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-foreground">Coming Soon</h1>
      {isLoading ? (
