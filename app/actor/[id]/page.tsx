    ...
    <div className="container mx-auto px-4 py-8">
            ...
            <div>
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white">{actor.stats.avgRating} Average Rating</span>
                </div>
                <div className="flex items-center gap-2">
                  <Award className="w-5 h-5 text-purple-500" />
                  <span className="text-white">{actor.stats.totalAwards} Awards</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-zinc-800 rounded-xl p-6">
              ...
              <dl className="space-y-4">
                <div>
                  ...
                  <dd className="text-white">{actor.birthDate}</dd>
                </div>
                <div>
                  <dt className="text-zinc-400">Place of Birth</dt>
                  <dd className="text-white">{actor.birthPlace}</dd>
                </div>
                <div>
                  <dt className="text-zinc-400">Movies</dt>
                  <dd className="text-white">{actor.stats.moviesCount} titles</dd>
                </div>
              </dl>
            </div>
        ...
        <div className="md:col-span-2">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-4 text-white">Awards & Nominations</h2>
                ...
                <Link key={movie.id} href={`/movie/${movie.id}`}>
                  <div className="bg-zinc-800 rounded-lg overflow-hidden hover:scale-105 transition-transform">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-zinc-400">as {movie.role}</p>
                      <p className="text-zinc-500 text-sm">{movie.year}</p>
                    </div>
                  </div>
                </Link>
              ))}
